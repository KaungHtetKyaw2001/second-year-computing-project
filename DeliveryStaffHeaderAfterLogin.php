    ...
    <nav class="main-header">
      ...
      <div id="menu">
        ...
        <ul class="text-center text-capitalize nav-agile" data-aos="zoom-in-up">
          <li>
            <a href="DeliveryStaffSchedule.php">Delivery Staff Schedules</a>
          </li>
          <li>
            <a href="DeliveryStaffUpdate.php">Delivery Staff Update</a>
          </li>
          <li>
            <button type="button" class="btn w3ls-btn">
            <a href="DeliveryStaffLogOut.php">Logout</a>
            </button>
          </li>
        </ul>
      </div>
