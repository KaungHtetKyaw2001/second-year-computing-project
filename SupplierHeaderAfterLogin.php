    ...
    <nav class="main-header">
      ...
      <div id="menu">
        ...
        <ul class="text-center text-capitalize nav-agile" data-aos="zoom-in-up">
          <li>
            <a href="SupplierUpdate.php">Supplier Update</a>
          </li>
          <li>
            <a href="Purchase.php">Purchase</a>
          </li>
          <li>
            <a href="PurchaseSearch.php">Purchase Search</a>
          </li>
          <li>
            <a href="PurchaseDetails.php">Purchase Details</a>
          </li>
          <li>
            <button type="button" class="btn w3ls-btn">
            <a href="SupplierLogOut.php">Log Out</a>
            </button>
          </li>
        </ul>
      </div>
