...
<title>Kaung Htet Kyaw Trading and Distribution</title>
<!-- for-mobile-apps -->
...
<header class="index-banner">
    ...
    <nav class="main-header">
      <div id="brand" data-aos="zoom-in-up">
        ...
        <div id="word-mark">
          <h1>
            <a href="index.html">KHK Trading and Distribution</a>
          </h1>
        </div>
      </div>
      <div id="menu">
        ...
        <ul class="text-center text-capitalize nav-agile" data-aos="zoom-in-up">
          <li>
           <h6><a href="StaffAdministration.php">Staff Administration</a></h6>
          </li>
          <li>
          	<div class="dropdown">
  			<button class="dropbtn">Type Register</button>
  			<div class="dropdown-content">
    		<a href="CustomerType.php">Customer Type</a>
    		<a href="ProductType.php">Product Type</a>
   		 	<a href="SupplierType.php">Supplier Type</a>
  			</div>
			</div>	
          </li>
          <li>
          	<div class="dropdown">
  			<button class="dropbtn">Type Assignation</button>
  			<div class="dropdown-content">
    		<a href="CustomerTypeAssign.php">Customer Type Assign</a>
   		 	<a href="SupplierTypeAssign.php">Supplier Type Assign</a>
  			</div>
			</div>
          </li>
          <li>
            <h6><a href="Department.php">Department</a></h6>
          </li>
          <li>
            <h6><a href="ProductRegister.php">Product Register</a></h6>
          </li>
          <li>
            <h6><a href="ImportCompany.php">Import Company</a></h6>
          </li>
          <li>
            <h6><a href="OrderHistory.php">Order History</a></h6>
          </li>
          <li>
            <h6><a href="Delivery.php">Delivery</a></h6>
          </li>
          <li>
				...
				<div class="slider-info col-lg-8">
					<div class="agileinfo-logo mt-5">
						<h2 data-aos="fade-down">
						 WELCOME FROM KAUNG HTET KYAW TRADING AND DISTRIBUTION COMPANY
						</h2>
					</div>
					<h3 class="txt-w3_agile" data-aos="fade-down">We sell the good and better qualified products to you </h3>
